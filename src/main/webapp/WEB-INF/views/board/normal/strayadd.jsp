...
<div class="top">
  ...
  <div id="add_wrap">
    <form method="post" action="../normal/add" enctype="multipart/form-data">
      <div id="form_wrap">
        <div id="title"><h1>게시글 등록</h1></div>
        <div><input type="hidden" name="usrId" value="${sessionScope.user.usrId}"></div>
        <div><input type="hidden" name="boardSort" value="1"></div>
        <div id="nick"><p>작성자: ${sessionScope.user.usrNickname}</p></div>
      
        
        <div id="boardTitle"><input type="text" name="boardTitle" placeholder="제목에 지역과 강아지를 찾는중인지 보호중인지 입력해 주세요."></div>
        ...
        <div id="content">
          <textarea  id="summernote" name="boardContent"></textarea>
            ...
            $('#summernote').summernote({
                ...
                maxHeight: 500,
                lang : 'ko-KR',
                placeholder:"강아지에 대한 상세한 설명을 입력해 주세요.",
                toolbar: [
