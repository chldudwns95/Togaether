  ...
  <div id="add_wrap">
    ...
    <c:forEach var="item" items="${item}">
      <div id="form_wrap">
        ...
        <div id="boardTitle"><input type="text" name="goodsName" placeholder="제목을 입력해주세요." value="${item.goodsName }"> </div>
        
        <div id="content">
          <textarea  id="summernote" name="goodsContent" value="${item.goodsContent}"></textarea>
        </div>
            <script>
